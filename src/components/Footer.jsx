  ...
  return (
    <section className="footer">
        ...
        <ul>
          <li>
            <a href="tel:123456789">
              <i class="fa-solid fa-phone"></i>&nbsp; &nbsp;(323)-858-2260
            </a>
          </li>
          <li>
            <a href="mailto:info@motorbikerental.com">
              <i class="fa-solid fa-envelope"></i>&nbsp;
              &nbsp;hamzaanjumrao@gmail.com
            </a>
          </li>
          <li>
      ...
      <div className="footer-3">
        ...
        <p>
          <i class="fa-sharp fa-solid fa-location-dot"></i>&nbsp; Comsats University Rd, off GT road،, Sahiwal, Sahiwal District, Punjab 57000
        </p>
      </div>
